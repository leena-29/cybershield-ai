...
class BreachDetector:
    ...
    def _build_result(email, breaches):
        ...
        suffix = 'es' if breach_count != 1 else ''
        indicators = (
            ['No breaches found']
            if breach_count == 0
            else [f'Email found in {breach_count} breach{suffix}']
        )
    ...
    def check_email(email):
        ...
        # Explicit no-breach mock scenario for predictable testing.
        if email_lower == 'safe@gmail.com':
